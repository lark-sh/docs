...
Head to the [Lark dashboard](https://admin.larkdb.net) and sign in with Google. Click **New Project** and give it a name — this generates a project ID you'll use to connect.
