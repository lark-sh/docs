...
<Note>
Self-hosting Lark? See the [open-source quickstart on GitHub](https://github.com/lark-sh/lark). This guide uses Lark Cloud, but everything after project setup is identical on both.
</Note>
