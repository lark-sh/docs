...
- Click **Export** to download the data at your current path as a `.json` file. Supports exports up to 256MB.
- Click **Import** to upload a `.json` file that replaces data at the current path. Supports imports up to 256MB.
