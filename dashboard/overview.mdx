...
The Lark dashboard is where you manage everything. Projects, databases, security rules, monitoring — it all lives at [admin.larkdb.net](https://admin.larkdb.net).

## Signing in

Sign in with Google OAuth at [admin.larkdb.net](https://admin.larkdb.net). Once authenticated, you land on your projects list.
