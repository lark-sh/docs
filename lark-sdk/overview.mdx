...
The SDK automatically negotiates the best transport available. When WebTransport (HTTP/3) is supported, you get lower latency and better multiplexing. It falls back to WebSocket seamlessly.
