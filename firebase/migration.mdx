...
- **Auto-create** — If you're using [database routing](/firebase/database-routing) to split data into separate databases, enable auto-create so Lark creates databases on first connect.
