...
<Steps>
  <Step title="Create a Lark project">
    Create a project in the [Lark dashboard](https://dashboard.larkdb.com). Note your project ID — you'll need it for the connection URL.
  </Step>
  <Step title="Enable Firebase compatibility">
    ...
    If your app uses path-based database routing (multiple "databases" via the first path segment), also enable **Use First Path as Database**.
  </Step>
