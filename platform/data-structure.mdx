...
- **Project** — A container for your app. You create projects in the [dashboard](https://admin.larkdb.net). Each project has a unique ID, security rules, and connection settings.
