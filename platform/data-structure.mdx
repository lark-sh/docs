...
A reference is a pointer to a specific path in your database. You don't read or write data directly. Instead, you create a reference to a path, then perform operations on it.
