...
| `lark.projectId` | string | The ID of the current project. |
| `lark.databaseId` | string | The ID of the current database (the database name, not including the project prefix). |
