...
Volatile paths are defined as patterns in your project configuration. You set them in the [Lark dashboard](https://dashboard.lark.sh) under **Project Settings > Volatile Paths**.
